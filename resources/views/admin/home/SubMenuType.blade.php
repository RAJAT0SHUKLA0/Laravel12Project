                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                     <a href= "{{route('editSubMenuType',[$menu->id])}}" class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="" data-bs-target=""><i class="ri-pencil-line"></i></a>
                                                                </div>
                                                                <div class="remove">
                                                                    <a href="{{route('DeleteSubMenuType',[$menu->id])}}" class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="" data-bs-target=""><i class="ri-delete-bin-2-line"></i></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
