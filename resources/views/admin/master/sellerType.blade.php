...
<div class="container-fluid mt-5">
                  ...
                  $action = isset($getState)
                     ? route('sellerTypeUpdate', $getState->id)
                     : route('sellerTypeSave');
            @endphp
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <div class="row">
                                           ...
                                           <div class="col-lg-4">
                                                <div>
                                                    <label for="basiInput" class="form-label">SELLER TYPE</label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Seller Type List</h4>
                        </div><!-- end card header -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                     <a href= "@encryptedRoute('editSellerType',$getStateList->id)" class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="" data-bs-target=""><i class="ri-pencil-line"></i></a>
                                                                </div>
                                                                <div class="remove">
                                                                    <a href="@encryptedRoute('softDeleteSellerType',$getStateList->id)" class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="" data-bs-target=""><i class="ri-delete-bin-2-line"></i></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
