             ...
             <div class="row">
                                                 ...
                                                 <table class="table table-borderless mb-0">
                                                     <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end tbl_td_padding">
                                                                {{ config('constants.INDIAN_RUPEE_SYMBOL') }} {{ $rounded }}
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        
                                                        <tr class="border-top border-top-dashed">
                                                            <th scope="row">Total ({{ config('constants.INDIAN_RUPEE_SYMBOL') }}) :</th>
                                                            <th class="text-end">
                                                                {{ config('constants.INDIAN_RUPEE_SYMBOL') }} {{ $rounded }}
                                                            </th>
                                                        </tr>
                 ...
                 <div class="col-xl-3">
                     ...
                     <div class="card">
                         <div class="card-header">
                             <div class="d-flex">
                                 <h5 class="card-title flex-grow-1 mb-0">Seller Details</h5>
                                 <div class="flex-shrink-0">
                                     <a href="@encryptedRoute('sellerprofile', $orderList->seller->id)" class="link-secondary">View Profile</a>
                                 </div>
                             </div>
                         </div>
                         <div class="card-body">
                             <ul class="list-unstyled mb-0 vstack gap-3">
                                 <li>
                                     <div class="d-flex align-items-center">
                                         <div class="flex-shrink-0">
                                             <img src="{{ asset('storage/uploads/profile/' . $orderList->seller->profile_pic) }}"
                                                 alt="" class="avatar-sm rounded material-shadow ">
                                         </div>
                                         <div class="flex-grow-1 ms-3">
                                             <h6 class="fs-14 mb-1">
                                                 {{ isset($orderList->seller->name) ? $orderList->seller->name : '' }}</h6>
                                             <p class="text-muted mb-0">seller</p>
                                         </div>
                                     </div>
                                 </li>
                                 <li><i
                                         class="ri-mail-line me-2 align-middle text-muted fs-16"></i>{{ isset($orderList->seller->shop_name) ? $orderList->seller->shop_name : '' }}
                                 </li>
                                 <li><i class="ri-phone-line me-2 align-middle text-muted fs-16"></i>+(91)
                                     {{ isset($orderList->seller->mobile) ? $orderList->seller->mobile : '' }}</li>
                             </ul>
                         </div>
                     </div>
